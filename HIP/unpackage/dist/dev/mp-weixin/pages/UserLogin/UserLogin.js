...
//
//
var _default = { onLoad: function onLoad() {uni.request({ url: 'http://192.168.43.181:8443/api/listDrug', method: 'GET', success: function success(res) {var temp = {};
        var drugList = [];
        ...
        _UserIndex.default.state.medicineInfoList = drugList;
        console.log(_UserIndex.default.state.medicineInfoList);
      } });
    ...
    uni.request({
      ...
      success: function success(res) {
        ...
        _UserIndex.default.state.doctorList = doctorList;
        console.log(_UserIndex.default.state.doctorList);
      } });
            ...
            success: function success(res) {
              ...
              uni.request({
                ...
                success: function success(res) {
                  ...
                  _UserIndex.default.state.user_id = _this.openid;
                  //获取用户信息
                  uni.getUserInfo({
                    provider: 'weixin',
                    success: function success(res) {
